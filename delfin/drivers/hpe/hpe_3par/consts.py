...
DISK_I_PATTERN = "^\\s*Id\\s+[-]*CagePos[-]*\\s+[-]*State[-]*\\s+" \
                 "Node_WWN\\s+MFR\\s+Model\\s+Serial\\s+FW_Rev"
...
PORT_CONNECTION_STATUS_MAP = {
    'CONFIG_WAIT': constants.PortConnectionStatus.CONNECTED,
    'ALPA_WAIT': constants.PortConnectionStatus.DISCONNECTED,
    'LOGIN_WAIT': constants.PortConnectionStatus.CONNECTED,
    'READY': constants.PortConnectionStatus.DISCONNECTED,
    'LOSS_SYNC': constants.PortConnectionStatus.CONNECTED,
    'ERROR_STATE': constants.PortConnectionStatus.DISCONNECTED,
    'XXX': constants.PortConnectionStatus.CONNECTED,
    'NONPARTICIPATE': constants.PortConnectionStatus.DISCONNECTED,
    'COREDUMP': constants.PortConnectionStatus.CONNECTED,
    'OFFLINE': constants.PortConnectionStatus.DISCONNECTED,
    'FWDEAD': constants.PortConnectionStatus.CONNECTED,
    'IDLE_FOR_RESET': constants.PortConnectionStatus.DISCONNECTED,
    'DHCP_IN_PROGRESS': constants.PortConnectionStatus.CONNECTED,
...
FS_STATUS_MAP = {
    'NORMAL': constants.FilesystemStatus.NORMAL,
    'DEGRADED': constants.FilesystemStatus.FAULTY,
    'FAILED': constants.FilesystemStatus.FAULTY
}
FSTORE_SECURITY_MODE = {
    'NTFS': constants.NASSecurityMode.NTFS,
    'LEGACY': constants.NASSecurityMode.NATIVE
}
FSHARE_PROTOCOL_MODE = {
    'SMB': constants.ShareProtocol.CIFS,
    'NFS': constants.ShareProtocol.NFS,
    'FTP': constants.ShareProtocol.FTP,
    'OBJ': constants.ShareProtocol.FTP
}
VOLUME_TYPE_MAP = {
    'FULL': constants.VolumeType.THICK,
    'TPVV': constants.VolumeType.THIN,
    'SNP': constants.VolumeType.THIN,
    'PEER': constants.VolumeType.THICK,
    'UNKNOWN': constants.VolumeType.THICK,
    'TDVV': constants.VolumeType.THIN,
    'DDS': constants.VolumeType.THICK}
