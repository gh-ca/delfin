...
class Hpe3parStorDriver(driver.StorageDriver):
    ...
    def list_filesystems(self, context):
        return self.comhandler.list_filesystems(self.storage_id)

    def list_qtrees(self, context):
        return self.comhandler.list_qtrees(self.storage_id)

    def list_shares(self, context):
        return self.comhandler.list_shares(self.storage_id)
