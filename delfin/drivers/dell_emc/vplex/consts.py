...
DISK_PYHSICAL_TYPE_MAP = {
    'normal': constants.DiskPhysicalType.UNKNOWN,
    'traditional': constants.DiskPhysicalType.UNKNOWN
}
DISK_LOGICAL_TYPE_MAP = {
    'used': constants.DiskLogicalType.MEMBER,
    'unclaimed': constants.DiskLogicalType.FREE,
    'meta-data': constants.DiskLogicalType.HOTSPARE,
    'unusable': constants.DiskLogicalType.MEMBER,
    'claimed': constants.DiskLogicalType.MEMBER
}
